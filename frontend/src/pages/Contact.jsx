...
export default function Contact() {
  ...
  const channels = [
    { Icon: Mail, label: t.contact.email, testId: "contact-email" },
    { Icon: Phone, label: t.contact.phone, testId: "contact-phone" },
    { Icon: Instagram, label: t.contact.instagram, testId: "contact-instagram" },
  ];
      ...
      <section className="py-20 md:py-28 px-5 md:px-10">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 space-y-4">
            {channels.map(({ Icon, label, testId }) => (
              <Reveal key={testId}>
                <div
                  data-testid={testId}
                  className="flex items-center justify-between gap-6 border border-[#F8FAFC]/10 p-5 md:p-6 hover:border-[#B7FF00]/50 transition-colors"
                >
