...
export default function Contact() {
  ...
  const channels = [
    ...
    { Icon: Mail, label: t.contact.email, testId: "contact-email", href: SOCIAL.emailUrl },
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            {channels.slice(1).map(({ Icon, label, testId, href }) => {
              ...
              const inner = (
                <>
                  ...
                  {href ? <ArrowUpRight size={16} className="text-[#B7FF00]" /> : <span className="w-1.5 h-1.5 bg-[#B7FF00]" />}
                </>
              );
              return (
                <Reveal key={testId}>
          ...
          <Reveal delay={200}>
            <div className="lg:col-span-5 border border-[#F8FAFC]/10 p-7 md:p-9 bg-[#0B1F33]/40">
              ...
              <p className="mt-3 text-sm text-[#A7B0BA]">International Tennis Coach · Performance Analyst · Tournament Director</p>
